...
'          + Ajout du plugin databaseinstances dans les logiciels
'
...
If Err = 0 Then
    ...
    If Err = 0 Then
                ...
                For Each objService in colServices
                    ...
                    If Err = 0 Then
                        For Each objSQLFile in colSQLFile
                            ...
                            ' On garde <DATABASEINSTANCES> pour le côté ergonomique sur l'interface Web OCS
                            Result = "<DATABASEINSTANCES>" & VbCrLf
                            ...
                            Result = Result & "</DATABASEINSTANCES>"
                            WScript.Echo Result
        ...
        Else
            ...
            ' Si des produits SQL Server sont installés, on précise dans DataBaseInstance qu'aucun service ne tourne pour ces produits.
                        ...
                        If strDisplayName <> "" Then
                            ...
                            If Not dicInstalledSoftwares.Exists(strDisplayName) Then
                                ...
                                If matchesSQLProduct.Count > 0 Then
                                    ' Ecrit les données de sortie en XML dans la table Databaseinstances
                                    Result = "<DATABASEINSTANCES>" & VbCrLf &_
